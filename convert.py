...
def hokkien_to_audio(sentence, save_directory, index):
    ...
    audio_filename = os.path.join(save_directory, f"{filename_prefix}{sentence[:10].replace(' ', '_')}.wav")
    with open(audio_filename, "wb") as file:
        file.write(audio_response.content)

    return f"Audio file saved as {audio_filename}", audio_filename

# File path for the CSV and directory to save audio files
csv_file_path = r"C:\Users\Aadit\OneDrive\Desktop\‎\Research LRL\HokkienTranslation\HokkienTranslation\data\new_flashcard_data_samples.csv"
audio_save_directory = r"C:\Users\Aadit\OneDrive\Desktop\‎\Research LRL\HokkienTranslation\HokkienTranslation\data\audio_files"
